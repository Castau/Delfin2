...
/**
 * ModelController handles DataFileAccessor and uses Model to write to file.
 *
 * @author Camilla
 */
public class ModelController
{
     ...
     * Model object to the content of the file or creates a new empty file, if
     * no file exists.
     */
    ...
    /**
     * This method adds a Member object to the Model object and writes the Model
     * object to the file
     *
    ...
    /**
     * This method adds a MemberCompetitive object to the Model object and
     * writes the Model object to the file
     *
    ...
    /**
     * This method edits a MemberActive object in the Model object and writes
    ...
    /**
     * This method edits a MemberCompetitive object in the Model object and
     * writes the Model object to the file
     *
     * @param member, MemberCompetitive object
     * @throws IOException if an error in the filewriting occurs.
    ...
    /**
     * This method returns an ArrayList containing all Member (and children of
     * Member) objects that are saved in the Model object
     *
     ...
     * saves the Member object in the Model object and writes the Model object
     * to the file
     *
     * @param memberID, int unique to a specific Member object
     ...
     * // * the Competition object belonging to a Member object (specified by
     * memberID), saves the Member object in the Model object and writes the
     * Model object to the file
     *
     * @param memberID int unique to a specific Member object
     * @param date, Date object
    ...
    /**
     * This method looks at each MemberCompetitve object saved in the Model
     * object and calls the getBestTraining(disciplineType, distance) for each
     * MemberCompetitve object, returning the TrainingSession, specified by the
     * given enums, whit the lowest timeInSec. MemberCompetitve objects who
     * return that TrainingSession object are added to a temporary ArrayList,
     * sortList. Using the java.util.Comparator compare method, the sortList is
     * sorted by each MemberCompetitive objects lowest timeInSec. Then up to 5
     * MemberCompetitive objects are added to the final ArrayList in the sorted
     * order
     *
     * @param disciplineType, enum
     * @param distance, enum
     * @param members, ArrayList of all MemberCompetitive objects saved in the
     * Model object
     * @return top5, sorted ArrayList containing up to 5 MemberCompetitive
     * objects
     */
    ...
    /**
     * This method looks at each MemberCompetitve object saved in the Model
     * object and calls the getBestCompetitionRes(disciplineType, distance) for
     * each MemberCompetitve object, returning the CompetitionResult, specified
     * by the given enums, whit the lowest timeInSec. MemberCompetitve objects
     * who return that CompetitionResult object are added to a temporary
     * ArrayList, sortList. Using the java.util.Comparator compare method, the
     * sortList is sorted by each MemberCompetitive objects lowest timeInSec.
     * Then up to 5 MemberCompetitive objects are added to the final ArrayList
     * in the sorted order
     *
     * @param disciplineType, enum
     * @param distance, enum
