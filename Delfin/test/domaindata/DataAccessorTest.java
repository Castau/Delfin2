...
public class DataAccessorTest {
    ...
    public void setUp() {
        ...
        MemberActive m3 = new MemberActive("Signe", Year.of(1996), MembershipType.ACTIVE, ActivityType.NORMAL);
        MemberActive m4 = new MemberActive("Otto", Year.of(1997), MembershipType.ACTIVE, ActivityType.NORMAL);
