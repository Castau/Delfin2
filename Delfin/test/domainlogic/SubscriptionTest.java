...
public class SubscriptionTest
{
    ...
    public void setUp()
    {
        a = new Member("Rúni", Year.of(1994), PASSIVE, yearsPaid);
        b = new MemberActive("Camilla", Year.of(1990), MembershipType.ACTIVE, yearsPaid, ActivityType.BASIC);
        c = new MemberCompetitive("Asger", Year.of(1995), MembershipType.ACTIVE, yearsPaid, ActivityType.COMPETITIVE, disciplineList);
    ...
    {
        Member aa = new Member("Rúni", Year.of(1994), PASSIVE, yearsPaid);
        assertEquals(aa, a);
    }
