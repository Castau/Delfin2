...
public class JsonTest
{
    ...
    public void memberToJsonTest()
    {
        ...
        Member member = new Member("Hans", Year.of(1902), MembershipType.PASSIVE, yearsPaid);
...
//        assertEquals(exp, jsonParser.memberToJSON(member));
    ...
    public void JsonToMemberTest()
    {
        ...
        Member memberExp = new Member("Hans", Year.of(1902), MembershipType.PASSIVE, yearsPaid);
